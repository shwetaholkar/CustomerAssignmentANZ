...
namespace MyTraining1121AngularDemo.Authorization
{
    ...
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            customerUsers.CreateChildPermission(AppPermissions.Pages_CustomerUser_Create, L("CreateNewCustomerUser"));
            customerUsers.CreateChildPermission(AppPermissions.Pages_CustomerUser_Edit, L("EditCustomerUser"));
            customerUsers.CreateChildPermission(AppPermissions.Pages_Customers_Delete, L("DeleteCustomerUser"));
