namespace MyTraining1121AngularDemo.Authorization
{
    ...
    public static class AppPermissions
    {
        ...
        public const string Pages_CustomerUser_Create = "Pages.CustomerUser.Create";
        public const string Pages_CustomerUser_Edit = "Pages.CustomerUser.Edit";
        public const string Pages_CustomerUser_Delete = "Pages.CustomerUser.Delete";
