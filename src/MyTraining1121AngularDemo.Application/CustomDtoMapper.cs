...
namespace MyTraining1121AngularDemo
{
    internal static class CustomDtoMapper
    {
        ...
        {
            configuration.CreateMap<User, UsersInCustomerDto>().ReverseMap();//source-destination

            configuration.CreateMap<CreateOrEditCustomerUserDto, CustomerUsers>().ReverseMap();
            configuration.CreateMap<CustomerUserDto, CustomerUsers>().ReverseMap();
